...
const abi = [
  ...
  { inputs: [], name: "NFT_MaxMintPerWalletReached", type: "error" },
  { inputs: [], name: "NFT__InsufficientEtherSent", type: "error" },
  { inputs: [], name: "NFT__MaxSupplyReached", type: "error" },
  {
    inputs: [{ internalType: "address", name: "owner", type: "address" }],
